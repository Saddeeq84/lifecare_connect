  ...
  Map<String, Map<String, dynamic>> _getDepartmentDetails() {
    return {
      ...
      'Infection Prevention and Control': {
        'description':
            'Prevents and monitors healthcare-associated infections through IPC audits, HAI surveillance, outbreak response, and hand hygiene monitoring',
        'services': [
          'Healthcare-associated infection surveillance',
          'CLABSI, CAUTI, SSI, VAP, CDI, and MDRO reporting',
          'Hand hygiene observation and compliance monitoring',
          'IPC audits and quality improvement',
          'Facility outbreak investigation and response',
          'Staff IPC training and protocol compliance',
        ],
        'roles': [
          'IPC Link Nurse',
          'IPC Doctor',
      ...
      'Microbiology': {
        ...
        'roles': ['Microbiologist', 'Lab Technician', 'IPC Specialist'],
      },
      'Histopathology': {
