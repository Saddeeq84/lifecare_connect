...
class _FacilityProfileScreenState extends State<FacilityProfileScreen> {
  ...
  Future<String?> _getCurrentUserId() async {
    // First try Firebase Auth (for email-based facility logins)
    final firebaseUser = FirebaseAuth.instance.currentUser;
    if (firebaseUser != null) {
      return firebaseUser.uid;
    }

    // Then try SharedPreferences (for Termii OTP logins)
                    ...
                    Stack(
                      children: [
                        Container(
                          ...
                          child: ClipOval(
                            child: _facilityData['logoUrl'] != null
                                ? Image.network(
                                    _facilityData['logoUrl'],
                                    fit: BoxFit.cover,
  ...
  Future<void> _pickAndUploadLogo() async {
    try {
      ...
      final storageRef = FirebaseStorage.instance.ref().child(
        'facility_logos/$userId/$fileName',
      );
      ...
      if (mounted) {
        setState(() {
          _facilityData['logoUrl'] = downloadUrl;
        });
