...
class _CHWProfileEditScreenState extends State<CHWProfileEditScreen> {
  ...
  void _populateFields(Map<String, dynamic> data, String? email) {
    ...
    if (data['birthDate'] != null) {
      ...
      if (data['dateOfBirth'] is Timestamp) {
        _selectedBirthDate = (data['dateOfBirth'] as Timestamp).toDate();
      } else if (data['dateOfBirth'] is String) {
        _selectedBirthDate = DateTime.tryParse(data['dateOfBirth']);
      }
    }
  }
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      // Prepare profile data - only update editable fields
      final profileData = {
      ...
      if (_selectedBirthDate != null) {
        profileData['birthDate'] = Timestamp.fromDate(_selectedBirthDate!);
        profileData['dateOfBirth'] = Timestamp.fromDate(_selectedBirthDate!);
      }

      // Add profile image URLs if uploaded
      if (imageUrl != null) {
      ...
      // Update users collection (main profile)
