      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final patientName =
                data['patientName'] ?? data['userName'] ?? 'Unknown Patient';
            final appointmentId = doc.id;
            final preConsultationData =
                data['preConsultationData'] as Map<String, dynamic>?;

            // Debug: Print appointment data to find missing fields
            if (patientId.isEmpty) {
              debugPrint('⚠️ Appointment $appointmentId is missing patientId');
                      ...
                      children: [
                          ...
                          onPressed: () {
                            if (preConsultationData != null &&
                              ...
                              final fields = <String, String?>{
                                ...
                                'Appointment Date': _formatAppointmentDate(
                            ...
                            if (preType.contains('anc') ||
                              ...
                              if (patientId.isEmpty || appointmentId.isEmpty) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Cannot open consultation: Missing patient information (ID: $patientId)',
                                    ),
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            final channelName =
                                'appointment_${appointmentId.isNotEmpty ? appointmentId : patientId}';
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // Try multiple field names for patient name
            final patientName =
                data['patientName'] ??
                data['userName'] ??
