        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 6),
              Text(
                'To provide accessible, quality healthcare to underserved communities through innovative digital health solutions.',
                style: TextStyle(fontSize: 16),
              ),
              SizedBox(height: 18),
              Text(
              ...
              SizedBox(height: 6),
              Text(
                'To be a leading digital health platform that transforms healthcare delivery in rural areas, ensuring every individual has access to quality medical care.',
                style: TextStyle(fontSize: 16),
              ),
              SizedBox(height: 18),
              Text(
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Compassion: We care deeply about the health and well-being of our patients.',
                      style: TextStyle(fontSize: 16),
                    ),
                  ),
                ],
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Innovation: We embrace technology to improve healthcare delivery.',
                      style: TextStyle(fontSize: 16),
                    ),
                  ),
                ],
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Collaboration: We work together with healthcare professionals and communities to achieve better health outcomes.',
                      style: TextStyle(fontSize: 16),
                    ),
                  ),
                ],
