            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Column(
                    children: [
                      Text('LifeCare Connect – Privacy Policy', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.teal)),
                      SizedBox(height: 8),
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    InkWell(
                      child: Text('https://lifecare-connect.web.app', style: TextStyle(fontSize: 16, color: Colors.teal, decoration: TextDecoration.underline)),
                      onTap: () {
