          ...
          child: Column(
            ...
            children: [
              Center(
                child: Column(
                  children: [
                    Text('LifeCare Connect – Privacy Policy', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.teal)),
                    SizedBox(height: 8),
                    Text('Effective Date: August 5, 2025', style: TextStyle(fontSize: 16, color: Colors.grey[700], fontWeight: FontWeight.w500)),
                    Text('Developed by: Rural Health Mission Nigeria', style: TextStyle(fontSize: 16, color: Colors.grey[700], fontWeight: FontWeight.w500)),
                  ],
                ),
              ),
              SizedBox(height: 22),
