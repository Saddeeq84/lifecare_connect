...
class FacilityStaffCreateAccountScreen extends StatefulWidget {
  ...
  const FacilityStaffCreateAccountScreen({super.key, required this.facilityName});

  @override
  State<FacilityStaffCreateAccountScreen> createState() => _FacilityStaffCreateAccountScreenState();
}

class _FacilityStaffCreateAccountScreenState extends State<FacilityStaffCreateAccountScreen> {
              ...
              ElevatedButton(
                onPressed: _isLoading ? null : () async {
                  ...
                  final staffData = {
                    ...
                    'profession': _selectedProfession == 'Other' ? _customProfession : _selectedProfession,
                  ...
                  try {
                    final collection = '${widget.facilityName.toLowerCase().replaceAll(' ', '_')}_users';
                    await FirebaseFirestore.instance.collection(collection).add(staffData);
                    final setupLink = 'https://lifecare-connect.web.app/staff-setup?staffId=${_staffIdController.text.trim()}';
