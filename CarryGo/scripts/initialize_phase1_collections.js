...
const collections = {
  ...
  orders: {
    ...
    order_status:
      "draft | pending_payment | searching_rider | accepted | picked_up | in_transit | delivered | cancelled | disputed | refunded",
...
(async () => {
  ...
  console.log(`Initialized Phase 1 collections in ${projectId}: ${written.join(", ")}`);
})().catch((error) => {
