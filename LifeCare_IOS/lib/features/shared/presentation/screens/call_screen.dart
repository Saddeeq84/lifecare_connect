  ...
  Future<void> _initAgora() async {
    try {
      ...
      await _engine.initialize(
        const RtcEngineContext(appId: 'a105462abb1746fc9075e6c2f81f5ac5'),
      );
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (!_joined) const Center(child: Text('Connecting to call...')),
          if (_joined && !widget.isVideo)
            Center(child: Icon(Icons.call, size: 100, color: Colors.green)),
        ],
      ),
    );
  }
