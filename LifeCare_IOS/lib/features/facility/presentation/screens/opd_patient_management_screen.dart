...
class OPDPatientManagementScreen extends StatelessWidget {
  final String facilityId;
  final String facilityName;
  final String doctorId;
  final String doctorName;

  const OPDPatientManagementScreen({
    super.key,
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => NursingInpatientsScreen(
          ...
          isViewOnly: true, // View-only mode for OPD dashboard
          // wardId is null for doctors to see all wards
        ),
      ),
    );
  }
